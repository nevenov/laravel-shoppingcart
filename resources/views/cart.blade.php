    ...
    <form method="POST" action="{{route('update-quantities')}}">
        <table class="table table-hover table-responsive">
            ...
            @foreach($cart_products as $id => $product)
                <tr>
                    ...
                    <td class="col-sm-1 col-md-1">
                        <input type="number" name="amounts[{{$product['id']}}]" min="0" class="form-control" value="{{$product['amount']}}">
                    </td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <a href="{{route('products')}}" role="button" class="btn btn-info">
                        Continue&nbsp;shopping
                    </a>
                </td>
                <td>
                    <a href="{{route('checkout')}}" role="button" class="btn btn-success">
                        Checkout
                    </a></td>
            </tr>
            </tbody>
